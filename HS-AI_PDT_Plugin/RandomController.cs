...
namespace HS_AI_PDT_Plugin
{
    public class RandomController : ThrowRandomController
    {
        ...
        public RandomController Clone()
        {
            ...
            clone.cardsToDraw = new List<Hearthstone_Deck_Tracker.Hearthstone.Entities.Entity>(cardsToDraw);
            clone.cardsToPick = new List<Hearthstone_Deck_Tracker.Hearthstone.Entities.Entity>(cardsToPick);
            clone.cardsToDiscover = new List<Hearthstone_Deck_Tracker.Hearthstone.Entities.Entity>(cardsToDiscover);
            return clone;
        }

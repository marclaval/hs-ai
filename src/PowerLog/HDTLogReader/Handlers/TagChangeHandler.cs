...
namespace Hearthstone_Deck_Tracker.LogReader.Handlers
{
	internal class TagChangeHandler
	{
		...
		public void TagChange(IHsGameState gameState, string rawTag, int id, string rawValue, Game game, bool isCreationTag = false)
		{
		...
		public void TagChange(IHsGameState gameState, GameTag tag, int id, int value, Game game, bool isCreationTag = false)
		{
